...
public class AmenityResource {
    ...
    @Timed
    public ResponseEntity<AmenityDTO> createAmenity(@RequestBody AmenityDTO amenityDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<AmenityDTO> updateAmenity(@RequestBody AmenityDTO amenityDTO) throws URISyntaxException {
    ...
    /**
     * SEARCH  /_search/amenities?query=:query : search for the amenity corresponding
     * to the query.
     *
    ...
    @Timed
    public ResponseEntity<List<AmenityDTO>> searchAmenities(@RequestParam String query, Pageable pageable) {

...
public class PortfolioResource {
    ...
    @Timed
    public ResponseEntity<List<PortfolioDTO>> searchPortfolios(@RequestParam String query, Pageable pageable) {
        log.debug("REST request to search for a page of Portfolios for query {}", query);
        Page<PortfolioDTO> page = portfolioService.search(query, pageable);

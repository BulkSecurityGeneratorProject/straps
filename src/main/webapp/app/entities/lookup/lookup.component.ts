...
export class LookupComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.lookupService
                ...
                .subscribe(
                    (res: HttpResponse<ILookup[]>) => this.paginateLookups(res.body, res.headers),
    ...
    trackId(index: number, item: ILookup) {
        return item.id;
    }
    ...
    protected paginateLookups(data: ILookup[], headers: HttpHeaders) {

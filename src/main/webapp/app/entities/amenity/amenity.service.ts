...
export class AmenityService {
    public resourceUrl = SERVER_API_URL + 'api/amenities';
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/amenities';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IAmenity[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}

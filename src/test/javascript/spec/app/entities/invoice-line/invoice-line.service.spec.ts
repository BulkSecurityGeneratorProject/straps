...
describe('Service Tests', () => {
    describe('InvoiceLine Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new InvoiceLine(0, 0, 0, 0, 0, 'AAAAAAA', 0, 0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a InvoiceLine', async () => {
            ...
            it('should update a InvoiceLine', async () => {
                const returnedFromService = Object.assign(
                    {
                        lineNum: 1,
                        invoiceId: 1,
            ...
            it('should return a list of InvoiceLine', async () => {
                const returnedFromService = Object.assign(
                    {
                        lineNum: 1,
                        invoiceId: 1,
            ...
            it('should delete a InvoiceLine', async () => {

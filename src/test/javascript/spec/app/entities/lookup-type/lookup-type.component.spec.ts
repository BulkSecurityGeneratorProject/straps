...
import { LookupTypeComponent } from 'app/entities/lookup-type/lookup-type.component';
...
describe('Component Tests', () => {
    describe('LookupType Management Component', () => {
        let comp: LookupTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LookupTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.lookupTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
import { DiscountPlanComponent } from 'app/entities/discount-plan/discount-plan.component';
...
describe('Component Tests', () => {
    describe('DiscountPlan Management Component', () => {
        let comp: DiscountPlanComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DiscountPlanComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.discountPlans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
import { DocumentStoreComponent } from 'app/entities/document-store/document-store.component';
...
describe('Component Tests', () => {
    describe('DocumentStore Management Component', () => {
        let comp: DocumentStoreComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DocumentStoreComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.documentStores[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
describe('Service Tests', () => {
    describe('DocumentStore Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new DocumentStore(0, 0, 'AAAAAAA', 'AAAAAAA', 0, 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a DocumentStore', async () => {
            ...
            it('should update a DocumentStore', async () => {
                const returnedFromService = Object.assign(
                    {
                        entityId: 1,
                        entityName: 'BBBBBB',
            ...
            it('should return a list of DocumentStore', async () => {
                const returnedFromService = Object.assign(
                    {
                        entityId: 1,
                        entityName: 'BBBBBB',
            ...
            it('should delete a DocumentStore', async () => {

...
import { PropertyUnitComponent } from 'app/entities/property-unit/property-unit.component';
...
describe('Component Tests', () => {
    describe('PropertyUnit Management Component', () => {
        let comp: PropertyUnitComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PropertyUnitComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.propertyUnits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

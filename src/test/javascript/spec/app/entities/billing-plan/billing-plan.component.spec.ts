...
import { BillingPlanComponent } from 'app/entities/billing-plan/billing-plan.component';
...
describe('Component Tests', () => {
    describe('BillingPlan Management Component', () => {
        let comp: BillingPlanComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BillingPlanComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.billingPlans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

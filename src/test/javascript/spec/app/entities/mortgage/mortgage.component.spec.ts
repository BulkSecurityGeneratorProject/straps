...
import { MortgageComponent } from 'app/entities/mortgage/mortgage.component';
...
describe('Component Tests', () => {
    describe('Mortgage Management Component', () => {
        let comp: MortgageComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MortgageComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.mortgages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

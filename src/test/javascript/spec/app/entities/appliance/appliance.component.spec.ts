...
import { ApplianceComponent } from 'app/entities/appliance/appliance.component';
...
describe('Component Tests', () => {
    describe('Appliance Management Component', () => {
        let comp: ApplianceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ApplianceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.appliances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

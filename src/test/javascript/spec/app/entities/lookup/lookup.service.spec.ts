...
describe('Service Tests', () => {
    describe('Lookup Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Lookup(0, 0, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Lookup', async () => {
            ...
            it('should update a Lookup', async () => {
                const returnedFromService = Object.assign(
                    {
                        companyId: 1,
                        lookupTypesId: 1,
            ...
            it('should return a list of Lookup', async () => {
                const returnedFromService = Object.assign(
                    {
                        companyId: 1,
                        lookupTypesId: 1,

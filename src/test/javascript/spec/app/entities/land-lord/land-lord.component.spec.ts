...
import { LandLordComponent } from 'app/entities/land-lord/land-lord.component';
...
describe('Component Tests', () => {
    describe('LandLord Management Component', () => {
        let comp: LandLordComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LandLordComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.landLords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
